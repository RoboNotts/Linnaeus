...
ultima_parser.add_argument("--fcos_model", default=linnaeus_ultima.DEFAULT_FCOS_MODEL, help="The YOLO model to use.")
ultima_parser.add_argument("--resnet_model", default=linnaeus_ultima.DEFAULT_RESNET_MODEL, help="The YOLO model to use.")
